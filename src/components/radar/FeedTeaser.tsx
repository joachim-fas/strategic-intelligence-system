      ...
      <div style={{ display: "flex", gap: 16, alignItems: "start" }}>
        ...
        <div style={{ flex: 1, display: "flex", gap: 6, overflowX: "auto", paddingBottom: 4 }}>
          {hotTrends.map(t => {
            ...
            return (
              <Link key={t.id} href="/verstehen" className="volt-card" style={{
        ...
        <div style={{ width: 320, flexShrink: 0, display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          {topSignals.map(s => {
            ...
            return (
              <a key={s.id} href={s.url ?? "/verstehen"} target={s.url ? "_blank" : "_self"} rel="noopener noreferrer"
                style={{
          ...
          <Link href="/verstehen" style={{ fontSize: 10, color: "var(--color-text-muted)", textDecoration: "none", marginTop: 2, paddingLeft: 6 }}
