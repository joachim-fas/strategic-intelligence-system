...
const en = {
  ...
  preFrage: {
    step1Title: "Reframing — Question Behind the Question",
    step1Desc: "Surface implicit assumptions and reformulate through different lenses",
    step2Title: "Decomposition + STEEP+V Lenses",
    step2Desc: "MECE sub-questions and dimensional lens questions",
    step3Title: "Inversion + Provocation",
    step3Desc: "Munger inversion, taboo questions, pre-mortem question, blind-spot questions",
    step4Title: "Critical Questions + Framework Roadmap",
    step4Desc: "Top-3 critical questions, knowledge gaps, recommended next frameworks",
    deeperQuestion: "The Deeper Question",
    implicitAssumptions: "Implicit Assumptions",
    reframings: "Reframings",
    subQuestions: "Sub-Questions (MECE)",
    lensQuestions: "Lens Questions (STEEP+V)",
    timeHorizonQuestions: "Time-Horizon Questions",
    inversionQuestions: "Inversion Questions",
    tabooQuestions: "Taboo Questions",
    premortemQuestion: "Pre-Mortem Question",
    blindSpotQuestions: "Blind-Spot Questions",
    criticalQuestions: "Top-3 Critical Questions",
    knowledgeGaps: "Knowledge Gaps",
    frameworkRoadmap: "Recommended Framework Sequence",
    explicitAssumptions: "Assumptions to Test Later",
    honestKnowledge: "Honest State of Knowledge",
    addressableBy: "Addressable by",
    whyCritical: "Why Critical",
    whyEssential: "Why Essential",
  ...
  howTo: {
    ...
    // leadP1 is rendered as: <prefix><strong>bold</strong><suffix>
    leadP1Prefix: "The ",
    leadP1Bold: "Strategic Intelligence System",
    leadP1Suffix: " is a thinking instrument for strategic foresight. It connects real-time signals from 50 live sources, 65+ research sources and a causal trend graph — and makes all of this accessible through a single question.",
    leadP2: "No dashboard. No tables. You ask a question — the system thinks.",
    leadCtaExamples: "View example briefings",
    // Section 1 — How a query works
    sectionQueryTitle: "How a query works",
    sectionQueryP: "Enter a question, topic or single keyword into the search bar. The system recognises the context, pulls in relevant signals and trends, and responds in a structured way — with citations, scenarios and action recommendations.",
    examplesHeading: "Examples — just type them in:",
    tipLabel: "Tip:",
    tipText: "SIS understands German and English equally well. Mix freely — what matters is the substance of the question, not the language.",
    // Examples list
    example1Input: "AI Agents",
    example1Hint: "Overview of state of the art, adoption, regulation",
    example2Input: "How is the energy transition developing in Germany?",
    example2Hint: "Contextual analysis with timelines and scenarios",
    example3Input: "Rural mobility",
    example3Hint: "A short keyword is enough — the system understands context",
    example4Input: "What does DORA mean for financial institutions?",
    example4Hint: "Regulatory questions with action recommendations",
    example5Input: "Quantum computing 2027",
    example5Hint: "Forecast question with time horizon",
    // Section 2 — What SIS returns
    sectionReturnsTitle: "What SIS returns",
    output1Label: "Synthesis",
    output1Desc: "The direct answer to your question — substantive, with inline citations. No surface-level summaries.",
    output2Label: "Insights",
    output2Desc: "3–5 concrete insights beyond the synthesis. Structural connections, surprises, contradictions.",
    output3Label: "Scenarios",
    output3Desc: "Optimistic / Most likely / Pessimistic — with probabilities. What happens if nothing changes? What if things go better or worse?",
    output4Label: "Causal network",
    output4Desc: "Cause-and-effect chains: which trends drive each other? Where are cascade effects? What are the real forces behind the topic?",
    output5Label: "Decision framework",
    output5Desc: "What to do? Concrete action recommendation based on the analysis — not a generic conclusion but an orientation point.",
    output6Label: "Live signals",
    output6Desc: "Which recent signals (last 72h) were used for this answer — with source, date and strength. Full transparency about the data basis.",
    // Section 3 — Navigation
    sectionNavTitle: "Understanding the navigation",
    nav1Label: "N Trends",
    nav1Desc: "All trends in the database — sorted by relevance. Click a trend to open the detail panel with sources, scoring and causal network.",
    nav2Label: "N Sources",
    nav2Desc: "65 authoritative research sources: WEF, PwC, EU ESPAS, Zukunftsinstitut, IPCC, Stanford HAI and more — grouped by category and linked.",
    nav3Label: "N Connectors",
    nav3Desc: "50 live data connectors: GitHub, arXiv, GDELT, Polymarket, World Monitor, NASA EONET, World Bank, Eurostat, OECD, Our World in Data, Hacker News, Reddit and more.",
    nav4Label: "Projects",
    nav4Desc: "Dedicated workspace: save queries with full content and reopen them, add notes, mark as active project — everything persisted in the database.",
    nav5Label: "Radar",
    nav5Desc: "The visualization shows all trends by ring (Adopt / Trial / Assess / Hold) and quadrant — interactive and clickable.",
    // Section 4 — Foundations
    sectionFoundationsTitle: "What SIS is built on",
    foundationsIntro: "The system combines three knowledge sources:",
    foundation1Title: "Analytical Framework",
    foundation1Desc: "STEEP+V methodology (Society, Technology, Economy, Environment, Politics, Values) — every analysis is systematically structured along these 6 dimensions. Aligned with the 14 EU JRC Megatrends of the European Commission.",
    foundation2Title: "Structural knowledge",
    foundation2Desc: "39 classified trends (Mega / Macro), 18 regulations from 5 jurisdictions, 70+ causal connections in the trend graph. Backed by 65 institutional research sources (PwC, EY, Roland Berger, OECD, EU JRC, etc.).",
    foundation3Title: "Real-time signals",
    foundation3Desc: "50 live connectors across 12 categories: tech adoption (GitHub, npm, arXiv, Docker Hub), news (Guardian, NYT, GDELT), forecasting (Polymarket, Metaculus, Kalshi), climate (NASA EONET, Open-Meteo), geopolitics (ACLED, UCDP), economics (Eurostat, OECD, World Bank, Finnhub, ILO), health (WHO GHO).",
    foundation4Title: "LLM analysis",
    foundation4Desc: "Claude synthesises structural knowledge + live signals into a coherent answer — with STEEP+V classification, explicit citations, scenarios and action recommendations. EU focus as default perspective.",
    // Section 5 — Limits
    sectionLimitsTitle: "Limitations & honesty",
    limitsIntro: "SIS is a thinking instrument, not an oracle. It helps you structure and reason through complex questions with evidence — but:",
    limit1: "Confidence scores indicate data quality — a low score is not an error, it is honest transparency.",
    limit2: "Live signals are titles and metadata from sources — not full articles (in development).",
    limit3: "Scenarios are thinking frameworks, not predictions. The most likely outcome rarely happens exactly as described.",
    limit4: "The system primarily covers technology, economics, climate, geopolitics — not niche topics without a data basis.",
    // Footer
...
const de: Dictionary = {
  ...
  preFrage: {
    step1Title: "Reframing — Die Frage hinter der Frage",
    step1Desc: "Implizite Annahmen aufdecken und durch verschiedene Linsen umformulieren",
    step2Title: "Decomposition + STEEP+V Linsen",
    step2Desc: "MECE-Sub-Fragen und dimensionale Linsen-Fragen",
    step3Title: "Inversion + Provokation",
    step3Desc: "Munger-Inversion, Tabu-Fragen, Pre-Mortem-Frage, Blind-Spot-Fragen",
    step4Title: "Kritische Fragen + Framework-Fahrplan",
    step4Desc: "Top-3 kritische Fragen, Wissens-Lücken, empfohlene nächste Frameworks",
    deeperQuestion: "Die tiefere Frage",
    implicitAssumptions: "Implizite Annahmen",
    reframings: "Umformulierungen",
    subQuestions: "Sub-Fragen (MECE)",
    lensQuestions: "Linsen-Fragen (STEEP+V)",
    timeHorizonQuestions: "Zeit-Horizont-Fragen",
    inversionQuestions: "Inversions-Fragen",
    tabooQuestions: "Tabu-Fragen",
    premortemQuestion: "Pre-Mortem-Frage",
    blindSpotQuestions: "Blind-Spot-Fragen",
    criticalQuestions: "Top-3 kritische Fragen",
    knowledgeGaps: "Wissens-Lücken",
    frameworkRoadmap: "Empfohlene Framework-Sequenz",
    explicitAssumptions: "Annahmen, die später zu prüfen sind",
    honestKnowledge: "Ehrlicher Wissensstand",
    addressableBy: "Adressierbar durch",
    whyCritical: "Warum kritisch",
    whyEssential: "Warum essentiell",
    whyImportant: "Warum wichtig",
  ...
  howTo: {
    leadHeadline: "Was ist das SIS — und wie nutzt man es?",
    leadP1Prefix: "Das ",
    leadP1Bold: "Strategic Intelligence System",
    leadP1Suffix: " ist ein Denk-Instrument für strategische Zukunftsanalyse. Es verbindet Echtzeit-Signale aus 50 Live-Quellen, 65+ Forschungsquellen und einem kausalen Trend-Graphen — und macht das alles über eine einzige Frage zugänglich.",
    leadP2: "Kein Dashboard. Keine Tabellen. Du stellst eine Frage — das System denkt.",
    leadCtaExamples: "Beispiel-Briefings ansehen",
    sectionQueryTitle: "So funktioniert eine Abfrage",
    sectionQueryP: "Gib eine Frage, ein Thema oder ein einzelnes Stichwort in die Suchleiste ein. Das System erkennt den Kontext, zieht relevante Signale und Trends heran und antwortet strukturiert — mit Quellenangaben, Szenarien und Handlungsempfehlungen.",
    examplesHeading: "Beispiele — einfach so eingeben:",
    tipLabel: "Tipp:",
    tipText: "Das SIS versteht Deutsch und Englisch gleichwertig. Misch ruhig — es kommt auf die Substanz der Frage an, nicht auf die Sprache.",
    example1Input: "AI Agents",
    example1Hint: "Überblick über den Stand der Technik, Adoption, Regulierung",
    example2Input: "Wie entwickelt sich die Energiewende in Deutschland?",
    example2Hint: "Kontextuelle Analyse mit Zeitrahmen und Szenarien",
    example3Input: "ÖPNV rural",
    example3Hint: "Kurzes Stichwort reicht — das System versteht den Kontext",
    example4Input: "Was bedeutet DORA für Finanzdienstleister?",
    example4Hint: "Regulatorische Fragen mit Handlungsempfehlungen",
    example5Input: "Quanten-Computing 2027",
    example5Hint: "Prognosefrage mit Zeithorizont",
    sectionReturnsTitle: "Was das SIS zurückgibt",
    output1Label: "Synthese",
    output1Desc: "Die direkte Antwort auf deine Frage — substanziell, mit Quellenangaben im Fließtext. Keine oberflächlichen Zusammenfassungen.",
    output2Label: "Erkenntnisse",
    output2Desc: "3–5 konkrete Insights, die über die Synthese hinausgehen. Strukturelle Zusammenhänge, Überraschungen, Widersprüche.",
    output3Label: "Szenarien",
    output3Desc: "Optimistisch / Wahrscheinlichst / Pessimistisch — mit Wahrscheinlichkeiten. Was passiert wenn sich nichts ändert? Was wenn es besser/schlechter läuft?",
    output4Label: "Kausal-Netz",
    output4Desc: "Ursache-Wirkungs-Ketten: Welche Trends bedingen einander? Wo sind Kaskadeneffekte? Was sind die echten Treiber hinter dem Thema?",
    output5Label: "Entscheidungsrahmen",
    output5Desc: "Was tun? Konkrete Handlungsempfehlung basierend auf der Analyse — kein generisches Fazit, sondern ein Orientierungspunkt.",
    output6Label: "Live-Signale",
    output6Desc: "Welche aktuellen Signale (letzte 72h) wurden für diese Antwort verwendet — mit Quelle, Datum und Stärke. Transparenz über die Datenbasis.",
    sectionNavTitle: "Die Navigation verstehen",
    nav1Label: "N Trends",
    nav1Desc: "Alle Trends in der Datenbank — sortiert nach Relevanz. Klick auf einen Trend öffnet das Detail-Panel mit Quellen, Scoring und Kausalnetz.",
    nav2Label: "N Quellen",
    nav2Desc: "65 autoritative Forschungsquellen: WEF, PwC, EU ESPAS, Zukunftsinstitut, IPCC, Stanford HAI u.v.m. — nach Kategorie gruppiert und verlinkt.",
    nav3Label: "N Connectors",
    nav3Desc: "50 Live-Daten-Connectors: GitHub, arXiv, GDELT, Polymarket, World Monitor, NASA EONET, World Bank, Eurostat, OECD, Our World in Data, Hacker News, Reddit u.a.",
    nav4Label: "Projekte",
    nav4Desc: "Eigene Seite für Projektarbeit: Abfragen mit vollständigem Inhalt speichern und wieder öffnen, Notizen hinzufügen, als aktives Projekt markieren — alles persistiert in der Datenbank.",
    nav5Label: "Radar",
    nav5Desc: "Die Visualisierung zeigt alle Trends nach Ring (Adopt / Trial / Assess / Hold) und Quadrant — interaktiv, klickbar.",
    sectionFoundationsTitle: "Worauf das SIS aufgebaut ist",
    foundationsIntro: "Das System kombiniert drei Erkenntnisquellen:",
    foundation1Title: "Analytisches Framework",
    foundation1Desc: "STEEP+V-Methodik (Society, Technology, Economy, Environment, Politics, Values) — jede Analyse wird systematisch entlang dieser 6 Dimensionen strukturiert. Orientierung an den 14 EU JRC Megatrends der Europäischen Kommission.",
    foundation2Title: "Strukturwissen",
    foundation2Desc: "39 klassifizierte Trends (Mega / Makro), 18 Regulierungen aus 5 Jurisdiktionen, 70+ kausale Verbindungen im Trend-Graphen. Belegt durch 65 institutionelle Forschungsquellen (PwC, EY, Roland Berger, OECD, EU JRC, u.a.).",
    foundation3Title: "Echtzeit-Signale",
    foundation3Desc: "50 Live-Connectors aus 12 Kategorien: Tech-Adoption (GitHub, npm, arXiv, Docker Hub), Nachrichten (Guardian, NYT, GDELT), Prognosen (Polymarket, Metaculus, Kalshi), Klima (NASA EONET, Open-Meteo), Geopolitik (ACLED, UCDP), Wirtschaft (Eurostat, OECD, World Bank, Finnhub, ILO), Gesundheit (WHO GHO).",
    foundation4Title: "LLM-Analyse",
    foundation4Desc: "Claude synthetisiert Strukturwissen + Live-Signale zu einer kohärenten Antwort — mit STEEP+V-Einordnung, expliziten Quellenangaben, Szenarien und Handlungsempfehlungen. EU-Fokus als Default-Perspektive.",
    sectionLimitsTitle: "Grenzen & Ehrlichkeit",
    limitsIntro: "Das SIS ist ein Denk-Instrument, kein Orakel. Es hilft dir, komplexe Fragen zu strukturieren und belegt zu durchdenken — aber:",
    limit1: "Confidence-Werte zeigen an, wie gut die Datenlage ist — ein niedriger Wert ist kein Fehler, sondern ehrliche Transparenz.",
    limit2: "Live-Signale sind die Titel und Metadaten von Quellen — keine vollständigen Artikel (in Entwicklung).",
    limit3: "Szenarien sind Denkrahmen, keine Vorhersagen. Das Wahrscheinlichste tritt selten genau so ein.",
    limit4: "Das System deckt primär Technologie, Wirtschaft, Klima, Geopolitik ab — keine Nischenthemen ohne Datenlage.",
