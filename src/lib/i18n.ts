...
const en = {
  ...
  preFrage: {
    step1Title: "Topic-Mapping",
    step1Desc: "Facets, stakeholders, world-model anchors, boundaries of the topic",
    step2Title: "Question Atlas",
    step2Desc: "7-9 core questions + 2-3 provocative + open research items, curated from a wider internal pool",
    step3Title: "Starter Sequence",
    step3Desc: "Top-3 starting questions in execution order with framework handoff and honest uncertainty",
    topicReformulation: "Topic Reformulation",
    facets: "Facets",
    ...
    connectedRegulations: "Connected Regulations",
    coreQuestions: "Core Questions",
    provocativeQuestions: "Provocative Questions",
    openResearch: "Open Research (no SIS framework fits)",
    starterSequence: "Recommended Starter Sequence (Top-3)",
    alternativeStarters: "Alternative Starters (depending on priority)",
    honestKnowledge: "Honest State of Knowledge",
    addressableBy: "Addressable by",
    whyMatters: "Why this matters",
    whyProvocative: "Why provocative",
    whyNoFramework: "Why no framework fits",
    wouldNeed: "Would need",
    facetReference: "Facet",
    rationale: "Rationale",
...
const de: Dictionary = {
  ...
  preFrage: {
    step1Title: "Themen-Mapping",
    step1Desc: "Facetten, Stakeholder, Welt-Modell-Anknüpfung, Grenzen des Themas",
    step2Title: "Frage-Atlas",
    step2Desc: "7-9 Core-Fragen + 2-3 provokante + Open-Research-Items, kuratiert aus einem größeren internen Pool",
    step3Title: "Starter-Sequenz",
    step3Desc: "Top-3 Einstiegs-Fragen in Reihenfolge mit Framework-Anschluss und ehrlicher Unsicherheits-Aussage",
    topicReformulation: "Themen-Schärfung",
    facets: "Facetten",
    boundaries: "Grenzen",
    inScope: "Im Scope",
    ...
    connectedRegulations: "Verbundene Regulierungen",
    coreQuestions: "Core-Fragen",
    provocativeQuestions: "Provokante Fragen",
    openResearch: "Open Research (kein SIS-Framework adressiert das)",
    starterSequence: "Empfohlene Starter-Sequenz (Top-3)",
    alternativeStarters: "Alternative Starter (je nach Priorität)",
    honestKnowledge: "Ehrlicher Wissensstand",
    addressableBy: "Adressierbar durch",
    whyMatters: "Warum das zählt",
    whyProvocative: "Warum provokant",
    whyNoFramework: "Warum kein Framework",
    wouldNeed: "Bräuchte",
    facetReference: "Facette",
    rationale: "Begründung",
    expectedOutput: "Erwarteter Output",
    enables: "Ermöglicht",
    dataAvailability: "Daten-Verfügbarkeit",
    classLabel: "Klasse",
  },
