...
/**
 * /projekte/archiv — Archived strategic projects.
 *
 * Shares hero structure and sub-nav with /projekte. Uses SessionList in
...
export default function ProjekteArchivePage() {
