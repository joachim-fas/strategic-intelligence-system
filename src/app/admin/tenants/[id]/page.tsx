/**
 * /admin/tenants/[id] — Mandant-Detail + Mitglieder-Verwaltung.
 *
 * System-admin only. Das Routing-Pattern ist identisch zu
 * /admin/tenants/page.tsx: Server guardet, Client rendert.
 *
...
export default async function TenantDetailPage({
  ...
  if (process.env.NODE_ENV !== "development") {
    ...
    if (!session?.user) {
      redirect(`/auth/signin?callbackUrl=/admin/tenants/${id}`);
    }
